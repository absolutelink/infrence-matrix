...
- `CACHE_PATH` - Path used by llama.cpp prompt cache files (default: "/cache")
...
- `POST /servers/delete` - Stop and remove a server
...
Completions, health, model, and cache requests while keeping the Halogen engine
port private. The fixed
