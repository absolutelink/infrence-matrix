...
export class ServerInstancesService {
     ...
     */
    public static instancesDeleteServer<ThrowOnError extends boolean = true>(options: Options<serverInstancesDeleteServerData, ThrowOnError>) {
        return (options.client ?? client).delete<serverInstancesDeleteServerResponses, serverInstancesDeleteServerErrors, ThrowOnError>({
            responseType: 'json',
     ...
     * Delete a server instance, stopping it on the agent if needed.
     */
    public static instancesDeleteServer2<ThrowOnError extends boolean = true>(options: Options<serverInstancesDeleteServerData, ThrowOnError>) {
        return (options.client ?? client).delete<serverInstancesDeleteServerResponses, serverInstancesDeleteServerErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/server-instances/{server_id}',
            ...options
     ...
     */
    public static instancesUpdateServer<ThrowOnError extends boolean = true>(options: Options<serverInstancesUpdateServerData, ThrowOnError>) {
        return (options.client ?? client).put<serverInstancesUpdateServerResponses, serverInstancesUpdateServerErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/server-instances/{server_id}',
            ...options,
            headers: {
     ...
     * Update server settings; restart the server if it is running.
     */
    public static instancesUpdateServer2<ThrowOnError extends boolean = true>(options: Options<serverInstancesUpdateServerData, ThrowOnError>) {
        return (options.client ?? client).put<serverInstancesUpdateServerResponses, serverInstancesUpdateServerErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/server-instances/{server_id}',
            ...options,
     ...
     */
    public static instancesInitializeExistingServer<ThrowOnError extends boolean = true>(options: Options<serverInstancesInitializeExistingServerData, ThrowOnError>) {
        return (options.client ?? client).post<serverInstancesInitializeExistingServerResponses, serverInstancesInitializeExistingServerErrors, ThrowOnError>({
            responseType: 'json',
     ...
     * Retry initialization and refresh metadata for an existing server.
     */
    public static instancesInitializeExistingServer2<ThrowOnError extends boolean = true>(options: Options<serverInstancesInitializeExistingServerData, ThrowOnError>) {
        return (options.client ?? client).post<serverInstancesInitializeExistingServerResponses, serverInstancesInitializeExistingServerErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/server-instances/{server_id}/initialize',
            ...options
     ...
     */
    public static instancesUpdateServerMetadata<ThrowOnError extends boolean = true>(options: Options<serverInstancesUpdateServerMetadataData, ThrowOnError>) {
        return (options.client ?? client).put<serverInstancesUpdateServerMetadataResponses, serverInstancesUpdateServerMetadataErrors, ThrowOnError>({
            responseType: 'json',
     ...
     * Update editable overrides without changing server runtime settings.
     */
    public static instancesUpdateServerMetadata2<ThrowOnError extends boolean = true>(options: Options<serverInstancesUpdateServerMetadataData, ThrowOnError>) {
        return (options.client ?? client).put<serverInstancesUpdateServerMetadataResponses, serverInstancesUpdateServerMetadataErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/server-instances/{server_id}/metadata',
            ...options,
...
export class V15 {
     ...
     */
    public static compactResponse<ThrowOnError extends boolean = true>(options: Options<v1ResponsesCompactResponseData, ThrowOnError>) {
        return (options.client ?? client).post<v1ResponsesCompactResponseResponses, v1ResponsesCompactResponseErrors, ThrowOnError>({
            responseType: 'json',
